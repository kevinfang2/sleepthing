   ...
   function createGraph(data, container) {
      ...
      var tableData = {
         ...
         chartYMax: function() {
            ...
            var chartYMax = Math.ceil(Math.max.apply(Math, chartData) / 10000) * 180;
            return chartYMax;
         },
         ...
         yLegend: function() {
            ...
            for (var i = 0; i < yAxisMarkings; i++) {
               yLegend.unshift(((chartYMax * i) / (yAxisMarkings - 1)) / 1); //THISODJFLSDKFJDLSKFJSLDK:FJLSD:FJLK:DSFJL:KSDFJL:
            }
            return yLegend;
         },
